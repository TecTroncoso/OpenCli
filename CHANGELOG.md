...
- Core: Remove Kimi provider and focus on OpenAI-compatible endpoints.
- Core: Add caching for LLM responses to improve performance.
- Core: Refactor LLM client for better extensibility.
- CLI: Remove `kimisoul.py` and other unused code.
